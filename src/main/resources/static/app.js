    ...
    $.each(timeTable.lessonList, (index, lesson) => {
      ...
      const lessonElementWithoutDelete = $(`<div class="card" style="background-color: ${color}"/>`)
        .append($(`<div class="card-body p-2"/>`)
          ...
          .append($(`<p class="card-text ml-2"/>`).text("class teacher: " + lesson.classTeacher));
...
function addLesson() {
  ...
  var teacher = $("#lesson_teacher").val().trim()
  var studentGroup = $("#lesson_studentGroup").val().trim()
  var numberOfLessons = $("#lesson_NumberOfLessons").val().trim()
  var isClassTeacher = $("#lesson_isClassTeacher").val().trim()
